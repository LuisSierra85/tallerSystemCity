 ...
 * @author Luis Sierra
 */
public class Admin_Paciente_Form extends javax.swing.JFrame {

    /**
     * Creates new form Admin_Paciente_Form
     */
...
public Admin_Paciente_Form() {
        initComponents();
        //cargo la tabla con los registros de los pacientes
        populateJtable();
        
         jTable_PACIENTE.setShowGrid(true);
        
         jTable_PACIENTE.setGridColor(Color.GREEN);
        
         jTable_PACIENTE.setSelectionBackground(Color.gray);
        
         JTableHeader th = jTable_PACIENTE.getTableHeader();

         th.setFont(new Font("Tahoma", Font.PLAIN, 16));
    }
    
  //función para crear la tabla de los registros de pacientes 
public void populateJtable(){
        //MVC
        controlador.Paciente paciente = new controlador.Paciente();
        ArrayList<controlador.Paciente> pacienteList = paciente.PacienteList();
        
        String[] colNames = {"Id","Document_Number","Document_Type","Full_Names","Full_Sur_Names",
            "Phone","Email","Gender","Emergency_Contact","Emergency_Phone","Date_of_Birth"};
      
        Object[][] rows = new Object[pacienteList.size()][11];
       //ciclo for como está en el constructor de la clase Paciente
        for(int i = 0; i < pacienteList.size(); i++){
            rows[i][0] = pacienteList.get(i).getId();
            rows[i][1] = pacienteList.get(i).getDocumentnumber();
            rows[i][2] = pacienteList.get(i).getDocumenttype();
            rows[i][3] = pacienteList.get(i).getFullnames();                    
            rows[i][4] = pacienteList.get(i).getFullsurnames();
            rows[i][5] = pacienteList.get(i).getPhone();
            rows[i][6] = pacienteList.get(i).getEmail();
            rows[i][7] = pacienteList.get(i).getGender();
            rows[i][8] = pacienteList.get(i).getEmergencycontact();
            rows[i][9] = pacienteList.get(i).getEmergencyphone();
            rows[i][10] = pacienteList.get(i).getDateofbirth().toString();
           
        }
        //Dibuja mi tabla
       modelo.TableModelPaciente mmd = new modelo.TableModelPaciente(rows, colNames);
        jTable_PACIENTE.setModel((TableModel) mmd);
        jTable_PACIENTE.setRowHeight(40);
        jTable_PACIENTE.getColumnModel().getColumn(0).setPreferredWidth(60);
        jTable_PACIENTE.getColumnModel().getColumn(1).setPreferredWidth(150);
        jTable_PACIENTE.getColumnModel().getColumn(2).setPreferredWidth(150);
        jTable_PACIENTE.getColumnModel().getColumn(3).setPreferredWidth(150);
        jTable_PACIENTE.getColumnModel().getColumn(4).setPreferredWidth(150);
        jTable_PACIENTE.getColumnModel().getColumn(5).setPreferredWidth(120);
        jTable_PACIENTE.getColumnModel().getColumn(6).setPreferredWidth(120);
        jTable_PACIENTE.getColumnModel().getColumn(7).setPreferredWidth(120);
        jTable_PACIENTE.getColumnModel().getColumn(8).setPreferredWidth(150);
        jTable_PACIENTE.getColumnModel().getColumn(9).setPreferredWidth(150);
        jTable_PACIENTE.getColumnModel().getColumn(10).setPreferredWidth(150);
        
    }
 //Array con todos los registros de mi tabla paciente       
public ArrayList<Paciente> getPacienteList()
    {
        ...
        try {
            ...
            { //cargo cada registro llamándolo desde la tabla con sus respectivos nombres de campos
                 paciente = new  Paciente(rs.getInt("id"),rs.getInt("documentnumber"),rs.getString("documenttype"),rs.getString("fullnames"),rs.getString("fullsurnames")
                         ,rs.getString("phone"),rs.getString("email"),rs.getString("gender"),rs.getString("emergencycontact"),
                         rs.getString("emergencyphone"),rs.getDate("dateofbirth").toLocalDate());
...
public void ShowItem(int index){
    ...
    jTextField_ID.setText(Integer.toString(getPacienteList().get(index).getId()));
    jTextField_DOCUMENTNUMBER.setText(Integer.toString(getPacienteList().get(index).getDocumentnumber()));

    // Tipo de Documento
    jCheckBox_TI.setSelected(getPacienteList().get(index).getDocumenttype().equals("TI"));
    jCheckBox_CC.setSelected(getPacienteList().get(index).getDocumenttype().equals("CC"));
    jCheckBox_CE.setSelected(getPacienteList().get(index).getDocumenttype().equals("CE"));
    //Campos de textos 
    jTextField_FULLNAMES.setText(getPacienteList().get(index).getFullnames());
    jTextField_FULLSURNAMES.setText(getPacienteList().get(index).getFullsurnames());
    jTextField_PHONE.setText(getPacienteList().get(index).getPhone());
    jTextField_EMAIL.setText(getPacienteList().get(index).getEmail());

    // Tipo de Género
    jCheckBox_MALE.setSelected(getPacienteList().get(index).getGender().equals("Male"));
    jCheckBox_FEMALE.setSelected(getPacienteList().get(index).getGender().equals("Female"));

    jTextField_EMERGENCYCONTACT.setText(getPacienteList().get(index).getEmergencycontact());
    jTextField_EMERGENCYPHONE.setText(getPacienteList().get(index).getEmergencyphone());

    // Fecha de nacimiento
    jXDatePicker1_DATEOFBIRTH.setDate(java.sql.Date.valueOf(getPacienteList().get(index).getDateofbirth()));
    }
 ...
 public boolean verifyFields(){
    ...
    // Fecha de nacimiento
    java.util.Date date = jXDatePicker1_DATEOFBIRTH.getDate();
    ...
    if (documentnumber.isEmpty() || documenttype.isEmpty() || fullnames.isEmpty() || fullsurnames.isEmpty() ||
        phone.isEmpty() || email.isEmpty() || gender.isEmpty() || emergencycontact.isEmpty() ||
        emergencyphone.isEmpty() || date == null) {
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(1107, 570));
        ...
        jTable_PACIENTE.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_OFF);
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(jTextField_FULLSURNAMES, javax.swing.GroupLayout.DEFAULT_SIZE, 203, Short.MAX_VALUE)))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(jTextField_EMERGENCYCONTACT)
                            .addComponent(jTextField_EMERGENCYPHONE)
                            .addComponent(jXDatePicker1_DATEOFBIRTH, javax.swing.GroupLayout.DEFAULT_SIZE, 203, Short.MAX_VALUE)
        ...
        jPanel1.setBounds(10, 0, 1070, 520);
    ...
    private void jTable_PACIENTEMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable_PACIENTEMouseClicked
     ...
     int rowIndex = jTable_PACIENTE.getSelectedRow();

    // Obtener datos de la tabla
    pacienteId = Integer.parseInt(jTable_PACIENTE.getValueAt(rowIndex, 0).toString());
    String documentType = jTable_PACIENTE.getValueAt(rowIndex, 2).toString();
    String genero = jTable_PACIENTE.getValueAt(rowIndex, 7).toString();

    // Asignar valores a los campos de texto
    jTextField_ID.setText(jTable_PACIENTE.getValueAt(rowIndex, 0).toString());
    jTextField_DOCUMENTNUMBER.setText(jTable_PACIENTE.getValueAt(rowIndex, 1).toString());
    jTextField_FULLNAMES.setText(jTable_PACIENTE.getValueAt(rowIndex, 3).toString());
    jTextField_FULLSURNAMES.setText(jTable_PACIENTE.getValueAt(rowIndex, 4).toString());
    jTextField_PHONE.setText(jTable_PACIENTE.getValueAt(rowIndex, 5).toString());
    jTextField_EMAIL.setText(jTable_PACIENTE.getValueAt(rowIndex, 6).toString());
    jTextField_EMERGENCYCONTACT.setText(jTable_PACIENTE.getValueAt(rowIndex, 8).toString());
    jTextField_EMERGENCYPHONE.setText(jTable_PACIENTE.getValueAt(rowIndex, 9).toString());

    // Convertir y asignar la fecha
    try {
        String fechaTexto = jTable_PACIENTE.getValueAt(rowIndex, 10).toString();
        java.util.Date fecha = java.sql.Date.valueOf(fechaTexto);
        jXDatePicker1_DATEOFBIRTH.setDate(fecha);
    } catch (Exception e) {
        jXDatePicker1_DATEOFBIRTH.setDate(null); // en caso de error
    }
    ...
    try {
        ...
        controlador.Paciente paciente = new controlador.Paciente(
            ...
            fullsurnames, phone, email, gender,
            emergencycontact, emergencyphone, dateofbirth
        );

        // Llamar al método que actualiza
        controlador.Paciente.updatePaciente(paciente);

        // Refrescar tabla y mostrar mensaje
        populateJtable();
        JOptionPane.showMessageDialog(null, "Paciente correctly updated");
    ...
    private void jButton_DELETEActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_DELETEActionPerformed
        ...
        {
            try {
                int id_paciente = Integer.parseInt(jTextField_ID.getText());
                 // Llamar al método que elimina
                controlador.Paciente.deletePaciente(id_paciente);
                populateJtable();
               
            } catch (Exception ex) {
                Logger.getLogger(Admin_Paciente_Form.class.getName()).log(Level.SEVERE, null, ex);
                JOptionPane.showMessageDialog(null, "Paciente Not Deleted");
            }
    ...
    private void jButton_INSERTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_INSERTActionPerformed
      ...
      try {
        ...
        // Llamar al método que inserta en bd
        controlador.Paciente.insertPaciente(paciente);

        // Refrescar tabla y mostrar mensaje
        populateJtable();
        JOptionPane.showMessageDialog(null, "Patient correctly admitted");
...
//Función para limpiar todos los campor con Botón
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Admin_Paciente_Form.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Admin_Paciente_Form().setVisible(true);
            }
        });
    }
